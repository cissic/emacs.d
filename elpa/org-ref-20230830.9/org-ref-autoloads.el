...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-ref-compat" '("org-ref-to-org-cite")))
...
;;;***

;;;### (autoloads nil "org-ref-extract" "org-ref-extract.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from org-ref-extract.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-ref-extract" '("org-ref-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-ref-isbn" '("isbn-to-bibtex-open-library" "org-ref-isbn-" "oricb-")))
