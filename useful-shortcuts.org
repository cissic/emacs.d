...
16. Znacznik czasowy (timestamp)
   : C-c .

17. Zamiana kolejności dwóch słów:
 : M-t       
 : M-x transpose-words

18. Zaznacz słowo pod kursorem
 : M-b C-M-SPACE
...
20. Zamieszczanie wyników obliczeń od razu jako wzory LaTeX:
 https://emacs-orgmode.gnu.narkive.com/1HleUR8q/o-workflow-matlab-latex-in-org-file

21. Doklejanie pliku do org-agenda, aby listowanie działało jak należy:
...
23. Poruszanie się po kalendarzu:
  https://emacs.stackexchange.com/questions/53715/how-to-schedule-exclusively-with-the-keyboard

24. Kopiowanie nazwy pliku otwartego w buforze do schowka:
  : copy-file-name-to-clipboard

25. Zamiana kolejności dwóch sąsiadujących linii (aktualna linię zamienia z górną)
  : C-x C-t
  : transpose-lines

26. Wcinanie bloków kodu - indentacja (indentation) i cofanie wcinania:
...
27. Odwracanie kolorów pdfa (https://www.reddit.com/r/emacs/comments/opkzxm/view_pdf_in_dark_mode_with_pdftools/):
    : M-x pdf-view-midnight-mode-minor
  (być może wcześniej trzeba ~pdf-view-mode~)

28. Inteligentne zaznaczanie bloku tekstu (Emacs sam zdecyduje o co Ci chodzi)
    : M-h

29. Zamiana akapitów na elementy listy:
    Zaznacz stosowny tekst a następnie:
    : C-c -
    a potem
    : <S-leftarrow/rightarrow>

30. Usuwanie pustych znaków z początku linii
